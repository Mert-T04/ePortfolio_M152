...
<div class="home-content flex items-center align-center flex-col">
    ...
    <Card class="mb-16" img="droneEditedSquare.jpg" href="/2023/ina4a/gruppe20/images" horizontal reverse={false} >
    ...
    <Card class="mb-16" img="setup/goggles.jpg" href="/2023/ina4a/gruppe20/setup" horizontal reverse={true} >
