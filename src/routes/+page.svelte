...
<div class="emotion-content flex items-center justify-around flex-col">
    <h1 class="text-3xl md:text-6xl font-bold text-white drop-shadow-lg italic text-center">
...
<div class="home-content flex items-center align-center flex-col">
    ...
    <Card class="mb-16" img="droneEditedSquare.jpg" href="{base}/images" horizontal reverse={false} >
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-primary-400">Bildergalerie</h5>
    ...
    <Card class="mb-16" img="setup/goggles.jpg" href="{base}/setup" horizontal reverse={true} >
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-primary-400">Setup</h5>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 leading-tight">
            Hinter dem Hobby steckt mehr als nur die Drohne. Damit man abheben kann, braucht man eine Reihe von Geräten und das benötigte Verständnis dafür.
        </p>
    </Card>
</div>
...
<style>
    :global(:root) {
        --emotion-trimmed-height: calc(100vh - 3.5rem);
    }
    .emotion-content {
        height: var(--emotion-trimmed-height);
    }
    .emotion-image {
        position: absolute;
        top: 3.5rem;
    ...
    .gradient-text {
        background: linear-gradient(to right, #0053FA, #00F6FF);
